...
var
  WebModuleClass: TComponentClass = TWebTest;
...
procedure TWebTest.WebModuleCreate(Sender: TObject);
begin
...
procedure TWebTest.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
